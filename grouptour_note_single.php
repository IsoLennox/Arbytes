...
echo "<div class='singlenote'><span class='right'> By: <a href='grouptour_profile.php'>Member Name</a> |  Date Time</span><h2>Post Title</h2><br/>In quid dolore minim cernantur. Magna nescius in comprehenderit ab lorem hic 
nostrud o velit.<br/>  "; 
                
               
                    echo "<span class='right'><a href='#'><img src=\"img/icons/tiny-newpost.png\"/> Edit Note</a></span>";
...
<?php
    ...
    echo "<div class='note'>From: <a href='grouptour_profile.php'>Commenter Name</a><span class='right'> Date Time</span><br/><br/>Well <em>said!</em> <br/>";
