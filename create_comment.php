...
$post_id=$_GET['post_id'];
  ...
  if (empty($errors) ) {
    ...
    if ($new_comment_created) {
        ...
        //get comment ID 
        $comment_query  = "SELECT * FROM comments WHERE content={$content} ORDER BY id DESC LIMIT 1"; 
        ...
        $notification_content = mysql_prep("<i class=\"fa fa-comments\"></i>  New comment on your post: '<a href=\"post_single.php?post_id=".$post_id."\">$post_title</a>'!");
