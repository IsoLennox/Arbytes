          ...
          function checkPass()
{
 ...
 <body> 
          <img src="img/full_logo3.png" title="arbytes logo" />
  <div id="create">
    <?php echo message(); ?>
    ...
    <form action="new_user.php" method="post">
        ...
        <p id="f-error">First Name:
        <input type="text" name="first_name" id="fname" value="" /> </p>
        
         <p id="l-error">Last Name:
        <input type="text" name="last_name" id="lname" value="" /> </p>
    ...
    <p id="u-error">Create a username (case sensitive):
